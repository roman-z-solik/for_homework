...
данные о банковских операциях: JSON, CSV или XLSX и возвращает список 
транзакций.
...
`sort_re`  
Универсальная функция, принимает список словарей с данными 
о банковских операциях и строку поиска, после чего возвращает
список словарей, у которых в описании есть данная строка.

`sort`  
Функция принимает список словарей с данными о банковских 
операциях, строку для сортировки, строку статуса для 
реверса сортировки, сортирует список, после чего возвращает
список словарей.

`user_input_y_n`  
Функция, отпределяющая, оветил пользователь 
ДА или НЕТ на вопрос.

`user_input_search`  
Функция поиска определяемой пользователем строки в списке транзакций,
и выдает отсортированный список по запросу пользователя.
